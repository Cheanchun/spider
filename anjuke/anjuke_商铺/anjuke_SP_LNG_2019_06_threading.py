...
PROXIES = [
    ...
    "36.32.44.245:4226",
    "112.65.52.12:4275",
    "101.206.237.147:4284",
    "112.114.164.84:4228",
    "115.223.184.241:4231",
    "124.163.72.63:4281",
    "39.66.12.76:4274",
    ...
    def _get(self, url, headers):
        ...
        if self.headers:
            for k, v in self.headers.items():
                h[k] = v
        try:
            resp = requests.get(url, headers=h, allow_redirects=False, proxies=proxy)
            if resp.ok:
                return resp
        ...
        for item in items:
            ...
            if "1" in floor or u"一" in floor:
                ...
                try:
                    ...
                    # json.loads(data, skipkeys=True, ensure_ascii=False, encoding="utf-8")
                    print(data)
