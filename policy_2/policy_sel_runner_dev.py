...
from policy_common.formatter import Formatter
from policy_common.parser import Parser
from policy_common.configuration import ATTACH_RE
...
class SeleniumPolicySpider(DevelopJobBase):
	def __init__(self):
