...
config = [
...

	{
		"site_config": {
			...
			'list_parse_rule': "//div[@class='san-grid-m li-item-m']/a",
			'total_page': 2,  # 2
			'handler': '3-chinamoney',
	...
	{
		"site_config": {
			'index_url': 'http://www.forestry.gov.cn/sites/main/main/gov/govindex.jsp',
			'list_parse_rule': "//a[@class='tooltip']",
			'total_page': 50,  # 85
			'handler': '2-oschina',
			'category': '信息发布>林业信息公开',
			'website': '林业草原局',
			'redis_key': 'policy:audit:oschina-1',
		},
		"sel_config": {
			'chrome_init': [],
			'proxy_type': '',
			'next_page_btn': {
				'by_xpath': "//div/center/a[6]",
				'by_id': '',
				'by_class': '',
			},
			'waiting_page': {
				'by_xpath': "//a[@class='tooltip']",
				'by_id': '',
				'by_class': '',
			},
		},
...

	{
		"site_config": {
			...
			'list_parse_rule': "//a[@class='title fs14 clear']/span[@class='txt fl']",
			'total_page': 2,  # 2
			'handler': '3-sge',
			'category': ' 首页 > 上金所公告',
			'website': '上海金交所',
