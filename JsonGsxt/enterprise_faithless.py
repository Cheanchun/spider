...
class ApiEnterprise(BaseConfig):
    ...
    def _get_proxy(self):
        ...
        if not self.proxies:
            self.delay(1, 3)
            print(requests.get('http://wapi.http.cnapi.cc/index/index/save_white?neek=64539&appkey=aa8aee21bfe8659af426549a0ccece21&white=101.206.169.103').json())
    ...
    def _save_data(self, data: dict):
        print(data)
        # self.r.zadd(REDIS_KEY, {str(data): SCORE})
